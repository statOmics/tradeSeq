---
title: 'Differential expression and clustering'
...
output: 
  rmarkdown::html_document:
    ...
    toc_depth: 3
vignette: >
  %\VignetteIndexEntry{Differential expression and clustering}
...
Here we fit the `tradeSeq` negative binomial generalized additive model (NB-GAM).
Please see the [fitGAM vignette](https://bioconductor.org/packages/release/bioc/vignettes/tradeSeq/inst/doc/fitGAM.html) for an extensive description on how to use this function, decide on the number of knots and its options.
