...
We find two trajectories for this dataset. We can further color the cells according to their cell type.
...
Another related test is whether all coefficients are equal (but necessarily equal to zero). This can be done with the association test.
