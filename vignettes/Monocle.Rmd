...
We find 3 lineages in this case, instead of the two that are supposed to be in the dataset but it for this dataset. The trajectory can be visualized using the `plotGeneCount` function, using either the cluster labels or cell type to color the cells.
