...
Then, the `sce` object can be analyzed following the [main vignette](https://bioconductor.org/packages/release/bioc/vignettes/tradeSeq/inst/doc/tradeSeq.html).
